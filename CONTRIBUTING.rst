...
We appreciate help from the community to make LMU better.

Filing issues
=============

If you find a bug in LMU,
or think that a certain feature is missing,
please consider
`filing an issue <https://github.com/lmu/issues>`_!
...
If you want to fix a bug or add a feature to LMU,
